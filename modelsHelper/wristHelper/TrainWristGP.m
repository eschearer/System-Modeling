function trainOut=TrainWristGP(DoF,muscle,trainingInputs,trainingOutputs,params)
%%%%%%%%
hyp.cov=params;
hyp.lik=log(10);
%hyp.mean=[0 0];
...
hyp2 = minimize(hyp, @gp, -100, @infExact, meanfunc, covfunc, likfunc, trainingInputs, trainingOutputs);
[mtrain,s2train] = gp(hyp2, @infExact, meanfunc, covfunc, likfunc, trainingInputs, trainingOutputs, trainingInputs);
