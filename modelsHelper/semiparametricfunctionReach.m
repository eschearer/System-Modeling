...
if strcmp(joint,'ElevationPlane')
    PHI1training = compute_phi1(trainingInputs)';
    PHI1test = compute_phi1(testInputs)';
    covSIMPLE1 = {@cov1};
    meanfunc1 = @mean1;
end
if strcmp(joint,'ShoulderElevation')
    PHI1training = compute_phi2(trainingInputs)';
    PHI1test = compute_phi2(testInputs)';
    covSIMPLE1 = {@cov2};
    meanfunc1 = @mean2;
end
if strcmp(joint,'ShoulderRotation')
    PHI1training = compute_phi3(trainingInputs)';
    PHI1test = compute_phi3(testInputs)';
    covSIMPLE1 = {@cov3};
    meanfunc1 = @mean3;
end
if strcmp(joint,'ElbowFlexion')
    PHI1training = compute_phi4(trainingInputs)';
    PHI1test = compute_phi4(testInputs)';
    covSIMPLE1 = {@cov4};
    meanfunc1 = @mean4;
end
if strcmp(joint,'ElbowPronation')
    PHI1training = compute_phi5(trainingInputs)';
    PHI1test = compute_phi5(testInputs)';
    covSIMPLE1 = {@cov5};
    meanfunc1 = @mean5;
end
